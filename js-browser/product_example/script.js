const cardsData = [
  ...
  const createCard = function (product) {
    ...
    const title = makeElement('h2', 'product__title', product.text);
    ...
    const price = makeElement('p', 'product__price', product.price);
    ...
    if (product.isSpecial) {
      ...
      const specialPrice = makeElement('p', 'product__special-price', product.specialPrice);
